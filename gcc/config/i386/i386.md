   ...
   ""
{
  if (! (reload_in_progress || reload_completed))
  {
    ...
    //else if (!o386_valid_address(operands[0], SImode, false))
    //  operands[0] = o386_legitimize_address (operands[0], operands[0],SImode);
    //else if (!o386_valid_address(operands[1], SImode, false))
    //  operands[1] = o386_legitimize_address (operands[1], operands[1],SImode);
  }
})
...
(define_insn "*reg_compare"
  [(set (reg:CC O386_EFLAGS)
        (compare:CC (match_operand:SI 0 "general_operand" "rCA")
                    (match_operand:SI 1 "general_operand" "rCA")
        )
  )
  ]
 ""
