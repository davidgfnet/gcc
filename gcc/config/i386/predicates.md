;; Predicate definitions for o386 (obfuscated i386 backend)
...
;; Named registers, cause x86 loves implicit registers :D

(define_predicate "eflags_register"
    (and (match_code "reg")
         (match_test "REGNO (op) == O386_EFLAGS")
    )
)
